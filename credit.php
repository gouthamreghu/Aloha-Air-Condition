...
if (isset($_POST['cc'])) {
    ...
    //echo $ad_id;
    $q="UPDATE credit_debit SET cr_cnumber='$number',cr_cvv='$cvv',cr_cname='$cname',cr_date='$date' WHERE cr_id=$cr_id";
    //var_dump($q);
											...
											<div class="credit-card-wrapper">
												<div class="first-row form-group">
													...
													<div class="controls">
														...
														<input class="expiration-month-and-year form-control" type="text" name="date" placeholder="MM / YY">
													</div>
												</div>
												<button type="submit" name="cc"><span>Make a payment </span></button>
											</div>
										</section>
									</form>
