...
if(isset($_POST['submit']))
{
    ...
    $s_type=$_POST['type'];
    $s_pcategory=$_POST['pcategory'];
    $s_serialno=$_POST['serialnumber'];
    $s_purchasedate=$_POST['pdate'];
    $s_productmodel=$_POST['model'];
     $s_visitdate=$_POST['vdate'];
    $s_description=$_POST['idescription'];
     $s_fname=$_POST['fname'];
     $s_lname=$_POST['lname'];
     $s_phone=$_POST['mphone'];
     $s_telephone=$_POST['tel'];
    $s_state=$_POST['state'];
     $s_city=$_POST['city'];
     $s_pincode=$_POST['pincode'];
     $s_address=$_POST['address'];
     $s_landmark=$_POST['landmark'];
     $s_email=$_POST['email'];
     $s_visittime=$_POST['vtime'];
    
 



      $q="INSERT INTO `service`(`sp_id`,`sl_id`,`s_type`, `s_pcategory`, `s_serialno`, `s_purchasedate`, `s_productmodel`, `s_visitdate`, `s_description`, `s_fname`, `s_lname`, `s_phone`, `s_telephone`, `s_state`, `s_city`, `s_pincode`, `s_address`, `s_landmark`, `s_email`, `s_visittime`)VALUES('$p_id','$l_id','$s_type','$s_pcategory','$s_serialno','$s_purchasedate','$s_productmodel','$s_visitdate','$s_description','$s_fname','$s_lname','$s_phone','$s_telephone','$s_state','$s_city','$s_pincode','$s_address','$s_landmark','$s_email','$s_visittime')";
   //var_dump($q);
  // exit();
...
<p></p></div>
<div class="col-md-6">
        <label>Service Type</label><span class="wpcf7-form-control-wrap menu-865"><select name="type" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false"><option value="">---</option><option value="Installation">Installation</option><option value="Repair">Repair</option></select></span>
    </div>
<div class="col-md-6">
        <label>Product Category</label><span class="wpcf7-form-control-wrap menu-368"><select name="pcategory" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" ><option value="<?php echo $result['p_category'];?>"><?php echo $result['p_category'];?></option><option value="Split Ac">Split Ac</option><option value="Window Ac">Window Ac</option><option value="Portable Ac">Portable Ac</option></select></span>
    </div>
<div class="col-md-6">
        <label>Serial Number</label><span class="wpcf7-form-control-wrap text-120"><input type="text" name="serialnumber" value="" size="40" maxlength="16" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Product Model</label><span class="wpcf7-form-control-wrap text-889"><input type="text" name="model" value="<?php echo $result['p_model'];?>" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Purchase Date</label><span class="wpcf7-form-control-wrap date-19"><input type="date" name="pdate" value="" class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" aria-required="true" aria-invalid="false"></span>
    </div>
</div>
<div class="ibid-contact-form row register">
<div class="col-md-12">
...
<p></p></div>
<div class="col-md-6">
        <label>Preferred Visit Date</label><span class="wpcf7-form-control-wrap date-802"><input type="date" name="vdate" value="" class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Preferred Visit Time</label><span class="wpcf7-form-control-wrap radio-991"><span class="wpcf7-form-control wpcf7-radio"><span class="wpcf7-list-item first"><input type="radio" name="vtime" value="10 AM - 12 Noon" checked="checked"><span class="wpcf7-list-item-label">10 AM - 12 Noon</span></span><span class="wpcf7-list-item"><input type="radio" name="vtime" value="12 Noon - 2 PM"><span class="wpcf7-list-item-label">12 Noon - 2 PM</span></span><span class="wpcf7-list-item"><input type="radio" name="vtime" value="2 PM - 4 PM"><span class="wpcf7-list-item-label">2 PM - 4 PM</span></span><span class="wpcf7-list-item last"><input type="radio" name="vtime" value="4 PM - 6 PM"><span class="wpcf7-list-item-label">4 PM - 6 PM</span></span></span></span>
    </div>
<div class="col-md-12">
        <label>Issue Description</label><span class="wpcf7-form-control-wrap textarea-75"><textarea name="idescription" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></textarea></span>
    </div>
</div>
<div class="ibid-contact-form row register">
<div class="col-md-12">
...
<p></p></div>
<div class="col-md-6">
        <label>First Name</label><span class="wpcf7-form-control-wrap text-941"><input type="text" name="fname" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Last Name</label><span class="wpcf7-form-control-wrap text-490"><input type="text" name="lname" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Mobile Phone</label><span class="wpcf7-form-control-wrap tel-519"><input type="tel" name="mphone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Telephone / Office No.</label><span class="wpcf7-form-control-wrap tel-241"><input type="tel" name="tel" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>State</label><span class="wpcf7-form-control-wrap text-774"><input type="text" name="state" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>City</label><span class="wpcf7-form-control-wrap text-530"><input type="text" name="city" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Pincode</label><span class="wpcf7-form-control-wrap text-975"><input type="text" name="pincode" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Address</label><span class="wpcf7-form-control-wrap text-194"><input type="text" name="address" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Landmark</label><span class="wpcf7-form-control-wrap text-674"><input type="text" name="landmark" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false"></span>
    </div>
<div class="col-md-6">
        <label>Email</label><span class="wpcf7-form-control-wrap email-676"><input type="email" name="email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false"></span>
    </div>
