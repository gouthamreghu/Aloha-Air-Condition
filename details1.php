...
if(isset($_POST['add']))
{
    ...
    $pid=$_POST['pid'];
      ...
      $q="INSERT INTO `addcart`(`adl_id`, `adp_id`, `ad_name`, `ad_price`,`ad_total`)VALUES('$l_id','$pid','$ad_name','$ad_price','$ad_total')";
   //var_dump($q);
  // exit();
		...
		<div class="shop_inner_inf">
			...
			<!-- 	<div class="color-quality">
				...
				<div class=""> 
				 <div class=""> 
						<form action="#" method="post"> 
							 <!-- <input type="hidden" name="" value="_cart"> -->
							<input type="hidden" name="pid" value="<?php echo $p_id;?>"> 
							<input type="hidden" name="ad_name" value="<?php echo $p_category;?>-<?php echo $p_ton;?>-<?php echo $p_star;?>&nbsp;Star(<?php echo $p_model;?>)">
							<input type="hidden" name="ad_price" value="<?php echo $p_price;?>"> 
							<input type="hidden" name="ad_total" value="<?php echo $p_price;?>"> 

							<input type="submit" name="add" value="Add to cart" class="button add">
