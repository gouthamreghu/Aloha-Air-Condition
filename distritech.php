			...
			<div class="left-ads-display col-md-12" >
				<div class="wrapper_top_shop">
					...
					<div class="product-sec1">
						<!--/mens-->
						<?php
// $s="SELECT *FROM service INNER JOIN distribute ON service.s_id = distribute.ds_id WHERE distribute.dsl_id=$l_id";
$s="SELECT * FROM((service INNER JOIN distribute ON service.s_id = distribute.ds_id) INNER JOIN technician ON technician.tl_id=distribute.dtl_id) where distribute.dsl_id=$l_id and distribute.dt_status='distribute'";
